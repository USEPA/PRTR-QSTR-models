...
<ol>
  ...
  <li>
    ...
    You will obtain a link like the following https://drive.google.com/drive/folders/folder-id?usp=sharing. The folder-id is what you will need to provide inside each notebook (see the example below)
    <p align="center">
